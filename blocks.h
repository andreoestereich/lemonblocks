...
static const bBlock blocks[] = {
	...
	{ run_command,        "%%{U#888B36}%s",           "dash /home/andrelo/.config/bspwm/statPP", 2, 10}, 
	{ run_command,        " %%{B#555803} %s ",           "xtitle -t 80", 1, 10}, 
	...
	{ temp,               "|%s°C",         "/sys/class/thermal/thermal_zone1/temp",  1,  0 },
